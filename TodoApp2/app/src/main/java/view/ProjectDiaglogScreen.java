 ...
 * @author 1310227
 */
public class ProjectDiaglogScreen extends javax.swing.JDialog {
    ...
    public ProjectDiaglogScreen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProjectDiaglogScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProjectDiaglogScreen dialog = new ProjectDiaglogScreen(new javax.swing.JFrame(), true);
